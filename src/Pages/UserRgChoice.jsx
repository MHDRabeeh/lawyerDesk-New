...
const UserRgChoice = () => {
  return (
    <SplashScreen sideImage={sideImage} imageSize="w-[44rem] h-[20rem]" divSize=" w-[40rem] h-[24rem]" >
      <div className="flex flex-col w-[92%] h-[92%]  mt-8 justify-between items-center ">
        <div className="">
          <img className="w-56" src={logo} alt="" />
        </div>
        <div className=" flex flex-col items-center text-3xl font-[700]"><span className="text-[#407BFF]">Join as us</span>Public, Lawyer or Student<span></span></div>
        <div className=" flex flex-col gap-4 items-center justify-center">
          <div>
            <button className="text-white font-[700] text-sm   bg-[#407BFF] rounded-full p-2 w-[20rem]
             border-2 border-[#407BFF]">Register as Public</button>
          </div>
          <div>
            <button className="text-[#407BFF] font-[800] text-sm  rounded-full p-2 w-[20rem] border-2
             border-[#407BFF]">Register as Lawyer</button>
          </div>
          <div>
            <button className="text-[#407BFF] font-[800] text-sm  rounded-full p-2 w-[20rem] border-2
             border-[#ffffff]">Register as Student</button>
          </div>
        </div>
